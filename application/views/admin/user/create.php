    ...
    <div class="col-md-4">
        <form role="form" method="post">
            ...
            <div class="form-group">
                ...
                <?php echo form_password('password',set_value('password'),'class="form-control" placeholder="Password" id="password"') ?>
            </div>
            <div class="form-group">
                <label for="confirmPassword">Password Confirmation</label>
                <?php echo form_password('password_confirm',set_value('password_confirm'),'class="form-control" placeholder="Confirm Password" id="password_confirm"') ?>
            </div>
